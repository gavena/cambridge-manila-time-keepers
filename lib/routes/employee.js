...
module.exports = (app) => {
    ...
    app.post('/employee/schedule/add/:username/:scheduleid', (req, res) => {
      console.log("req.params.username"+req.params.username+"  "+req.params.scheduleid);
        employee.findByUsernameAndSchedIdAndUpdate(req.params.username,req.params.scheduleid, (error, schedule) => {
            if (error !== null) {
                if (error.name === 'MongoError' && error.code === 11000) {
    ...
    app.post('/employee/schedule/delete/:username/:scheduleid', (req, res) => {
      console.log("req.params.username"+req.params.username+"  "+req.params.scheduleid);
        employee.findByUsernameAndSchedIdAndDelete(req.params.username,req.params.scheduleid, (error, schedule) => {
            if (error !== null) {
                if (error.name === 'MongoError' && error.code === 11000) {
                    // Duplicate schedule name
                    return res.send({
